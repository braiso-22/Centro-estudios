...
create or replace view profesor_con_alumno as select p.dni, p.nombre, p.apellidos, p.departamento, p.sueldo, a.nombre as alumno from profesor as p join detalle_clase as dc on p.dni = dc.profesor inner join alumno as a on dc.alumno = a.dni;